...
Netbeans NBM package: "off-netbeans-0.9.4.nbm":http://counter.sickill.net?f=http://drop.sickill.net/blog/off-netbeans-0.9.4.nbm
JEdit jar file: "off-jedit-0.9.4.jar":http://counter.sickill.net?f=http://drop.sickill.net/blog/off-jedit-0.9.4.jar (requires JEdit 4.3pre16 and ProjectViewer 2.1.3.7)

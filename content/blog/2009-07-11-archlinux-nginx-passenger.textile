...
3. Download this "PKGBUILD":http://counter.sickill.net?f=http://sickill.net/assets/archlinux-nginx-passenger.tgz (modified PKGBUILD of nginx-0.7.61-1 from community repository with passenger module added)

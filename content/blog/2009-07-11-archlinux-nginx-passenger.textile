...
3. Download this <%= download_link "PKGBUILD", "archlinux-nginx-passenger.tgz" %> (modified PKGBUILD of nginx-0.7.61-1 from community repository with passenger module added)

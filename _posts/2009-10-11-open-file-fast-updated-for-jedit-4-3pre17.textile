...
JEdit jar file: "off-jedit-0.9.4.1.jar":https://github.com/downloads/sickill/off-plugin/off-jedit-0.9.4.1.jar" (requires JEdit 4.3pre17 and ProjectViewer >= 2.9.1)
